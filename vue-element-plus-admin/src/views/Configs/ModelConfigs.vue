<template>
  <el-card class="!min-h-[calc(100vh-var(--top-tool-height)-var(--tags-view-height)-var(--app-footer-height))]">
    ...
    <Dialog v-model="dialogVisible" :title="dialogTitle" width="60%" align-center @close="handleDialogClose">
      <InferenceSchemaForm ref="schemaFormRef" :schema="configSchema" v-model="formData" @validate="handleFormValidate"
        @search="handleSearch" />
      <template #footer>
...
// Store
const systemConfigStore = useInferenceModelConfigStore()
